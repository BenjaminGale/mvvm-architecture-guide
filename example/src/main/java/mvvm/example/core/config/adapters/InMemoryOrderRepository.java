...
public class InMemoryOrderRepository implements OrderRepository {
    ...
    private void seed() {
        add("ORD-001", ACME_CORP,         LocalDate.now().minusDays(5),  LocalDate.now().plusDays(10),   OrderStatus.IN_PROGRESS, null,                          List.of(new LineItem(WIDGET_A, "Widget A", 10, new BigDecimal("9.99")), new LineItem(WIDGET_B, "Widget B", 5, new BigDecimal("24.99"))));
        add("ORD-002", GLOBEX_INC,         LocalDate.now().minusDays(45), LocalDate.now().minusDays(15),  OrderStatus.IN_PROGRESS, null,                          List.of(new LineItem(GIZMO_X, "Gizmo X", 2, new BigDecimal("149.00"))));
        add("ORD-003", INITECH,            LocalDate.now().minusDays(8),  LocalDate.now().plusDays(5),    OrderStatus.IN_PROGRESS, null,                          List.of(new LineItem(SPROCKET, "Sprocket", 20, new BigDecimal("4.50")), new LineItem(COG, "Cog", 8, new BigDecimal("12.75"))));
        ...
        add("ORD-006", CYBERDYNE_SYSTEMS,  LocalDate.now().minusDays(35), LocalDate.now().minusDays(5),   OrderStatus.IN_PROGRESS, null,                          List.of(new LineItem(WIDGET_A, "Widget A", 10, new BigDecimal("9.99")), new LineItem(WIDGET_B, "Widget B", 5, new BigDecimal("24.99"))));
    }
