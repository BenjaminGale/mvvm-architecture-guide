...
| **Request object**           | ViewModel | Short-lived object scoped to a single interaction. Carries input data for the target ViewModel and an output callback to return the result. |
